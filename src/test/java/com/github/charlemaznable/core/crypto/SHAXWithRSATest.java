...
public class SHAXWithRSATest {
    ...
    public void batchRun(SHAXWithRSA shax, int times) {
        ...
        for (var i = 0; i < times; ++i) {
            ...
            var signBase64 = shax.signBase64(plainText, privateKeyString);
