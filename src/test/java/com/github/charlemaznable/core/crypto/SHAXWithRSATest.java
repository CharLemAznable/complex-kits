...
import static com.github.charlemaznable.core.crypto.SHAXWithRSA.SHA1WithRSA;
import static com.github.charlemaznable.core.crypto.SHAXWithRSA.SHA256WithRSA;
...
public class SHAXWithRSATest {
    ...
    public void testSHA1WithRSA() {
        ...
        val signBase64 = SHA1WithRSA.signBase64(plainText, privateKeyString);
        assertTrue(SHA1WithRSA.verifyBase64(plainText, signBase64, publicKeyString));

        val signHex = SHA1WithRSA.signHex(plainText, privateKeyString);
    ...
    public void testSHA256WithRSA() {
        ...
        val signBase64 = SHA256WithRSA.signBase64(plainText, privateKeyString);
        assertTrue(SHA256WithRSA.verifyBase64(plainText, signBase64, publicKeyString));

        val signHex = SHA256WithRSA.signHex(plainText, privateKeyString);
